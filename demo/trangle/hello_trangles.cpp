...
int hello_trangles()
{
    ...
    window.shader = &OpenGLToolsShader::OpenGLToolsShader("shaders/vertex_shader.shader", "shaders/fragment_shader.shader");
    ...
    window.invalidate();
    window.startWindowLoop(tranglesWindowLoopCallback);
